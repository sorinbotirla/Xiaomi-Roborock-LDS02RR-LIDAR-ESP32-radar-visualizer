...
You have to connect it first. If already connected, try increasing the motor speed slider and click the speed set button. Do not run Arduino IDE and the WebApp page at the same time. Close the Arduino IDE when opening the Web App.
